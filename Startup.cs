...
namespace CustomizableWallClock
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddSignalR().AddAzureSignalR("Endpoint=https://smartwallclock2020.service.signalr.net;AccessKey=AIltvQ7xJDaG50xxt8G8n0lIS1nmWpWVOV/ukgWYxwA=;Version=1.0;");
		}
